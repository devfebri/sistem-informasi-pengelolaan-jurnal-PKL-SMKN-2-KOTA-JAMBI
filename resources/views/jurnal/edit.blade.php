...
<section class="content-header">
    <h1>
        <i class="fa fa-edit"></i> Edit Jurnal PKL
        <small>Form edit jurnal kegiatan PKL</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('jurnal.index') }}"><i class="fa fa-book"></i> Jurnal PKL</a></li>
        <li class="active"><i class="fa fa-edit"></i> Edit Jurnal</li>
    </ol>
</section>
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="box box-warning">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-edit"></i> Form Edit Jurnal PKL</h3>
                </div>
                <form action="{{ route('jurnal.update', $jurnal->id) }}" method="POST" id="editJurnalForm">
                    @csrf
                    @method('PUT')
                    <div class="box-body">
                        @if ($errors->any())
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="callout callout-warning">
                                    ...
                                    Jurnal yang sudah divalidasi akan kembali ke status "Menunggu Validasi" setelah diedit.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('kegiatan') ? 'has-error' : '' }}">
                            ...
                            <textarea name="kegiatan" id="kegiatan" class="form-control" rows="4" required 
                                      placeholder="Jelaskan kegiatan yang dilakukan secara ringkas dan jelas...">{{ old('kegiatan', $jurnal->kegiatan) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('deskripsi') ? 'has-error' : '' }}">
                            ...
                            <textarea name="deskripsi" id="deskripsi" class="form-control" rows="6" 
                                      placeholder="Jelaskan detail kegiatan, alat/software yang digunakan, hasil yang dicapai, kendala yang dihadapi, dll...">{{ old('deskripsi', $jurnal->deskripsi) }}</textarea>
                            <small class="text-muted">
