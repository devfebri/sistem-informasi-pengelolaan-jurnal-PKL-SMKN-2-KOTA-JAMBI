...
<section class="content-header">
    <h1>
        ...
        <small>Form edit data siswa PKL</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('siswa.index') }}"><i class="fa fa-graduation-cap"></i> Siswa</a></li>
        <li><a href="{{ route('siswa.show', $siswa->id) }}"><i class="fa fa-eye"></i> {{ $siswa->name }}</a></li>
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="box box-warning">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-edit"></i> Form Edit Siswa: {{ $siswa->name }}</h3>
                </div>
                <form action="{{ route('siswa.update', $siswa->id) }}" method="POST" id="siswaEditForm">
                    @csrf
                    @method('PUT')
                    <div class="box-body">
                        @if ($errors->any())
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('username') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" name="username" id="username" class="form-control" required 
                                           value="{{ old('username', $siswa->username) }}" placeholder="Masukkan username unik">
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('nisn') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" name="nisn" id="nisn" class="form-control" required 
                                           value="{{ old('nisn', $siswa->nisn) }}" placeholder="Masukkan NISN siswa" maxlength="10">
                                    @if($errors->has('nisn'))
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" name="phone" id="phone" class="form-control" 
                                           value="{{ old('phone', $siswa->phone) }}" placeholder="Contoh: 08123456789">
                                ...
                                <div class="form-group {{ $errors->has('guru_id') ? 'has-error' : '' }}">
                                    ...
                                    <select name="guru_id" id="guru_id" class="form-control">
                                        ...
                                        @foreach($gurus as $guru)
                                            <option value="{{ $guru->id }}" {{ old('guru_id', $siswa->guru_id) == $guru->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group {{ $errors->has('instansi_id') ? 'has-error' : '' }}">
                                    ...
                                    <select name="instansi_id" id="instansi_id" class="form-control">
                                        ...
                                        @foreach($instansis as $instansi)
                                            <option value="{{ $instansi->id }}" {{ old('instansi_id', $siswa->instansi_id) == $instansi->id ? 'selected' : '' }}>
                                                {{ $instansi->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
                                    <label for="password"><i class="fa fa-key"></i> Password Baru</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="password_confirmation"><i class="fa fa-key"></i> Konfirmasi Password Baru</label>
                    ...
                    <div class="box-footer">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <a href="{{ route('siswa.show', $siswa->id) }}" class="btn btn-info btn-block">
...
$(document).ready(function() {
    ...
    // Form validation
    $('#siswaEditForm').on('submit', function(e) {
